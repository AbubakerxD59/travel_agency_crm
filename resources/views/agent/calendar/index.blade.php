...
@section('content')
    <div class="mx-auto max-w-7xl">
        <div class="mb-8">
            ...
            <p class="mt-1 text-concierge-muted">Browse your folders by travel date across any month.</p>
        </div>
        ...
        <section id="dash-folder-calendar-details-outer"
            ...
            <div class="flex flex-col gap-3 border-b border-slate-100 px-5 py-4 sm:flex-row sm:items-center sm:justify-between md:px-6">
                ...
                <a id="dash-folder-calendar-details-full-link" href="{{ route('agent.folders.index') }}"
