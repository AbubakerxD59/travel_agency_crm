            ...
            <tbody class="divide-y divide-slate-100">
                @forelse ($folders as $folder)
                    @php
                        ...
                        if ($departureItinerary?->departure_date && $departureItinerary?->departure_time) {
                        ...
                        <td class="px-4 py-4 text-right lg:px-6">
                            <div class="inline-flex items-center justify-end gap-1 whitespace-nowrap">
                                ...
                                @include('partials.folders.transportation-voucher-action', [
                                    'folder' => $folder,
                                    'routeName' => ($routePrefix ?? 'admin') . '.folders.transportation-voucher',
                                ])
                ...
                @empty
                    <tr>
                        <td colspan="{{ $colspan }}" class="px-6 py-10 text-center text-sm text-concierge-muted">
                            No upcoming folders in this date range.
                        </td>
                    </tr>
                @endforelse
            </tbody>
